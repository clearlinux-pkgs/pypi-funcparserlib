...
%prep
%setup -q -n funcparserlib-1.0.0
cd %{_builddir}/funcparserlib-1.0.0
pushd ..
cp -a funcparserlib-1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653331867
...
cp %{_builddir}/funcparserlib-1.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-funcparserlib/9c43ed8af0243b23bbf87e137bfd753f4cc4b899
